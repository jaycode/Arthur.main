...
!function() {
    ...
    app.connection = {
        ...
        $.ajax({
            ...
            if ("success" == d) {
                var e = JSON.parse(c).workspace_path;
                app.connection.handler = new SockJS(e, b), app.connection.handler.onopen = function() {}, 
                app.connection.handler.onmessage = function(b) {
                    a.log(b.data);
                }, app.connection.handler.onclose = function() {
                    app.connection.handler = null;
                };
            } else alert("Error: Cannot connect to config page. Please refresh the page");
        });
